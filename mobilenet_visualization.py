...
def t0():
    ...
    mobilenet_v2_model = torch.jit.trace(net.eval(), _x)
    mobilenet_v2_model.save(path_dir / "mobilenet_v2.pt")
    print(net)
    print("=" * 100)
    net = models.mobilenet_v3_small(weights=models.MobileNet_V3_Small_Weights.IMAGENET1K_V1)
    mobilenet_v3_smallmodel = torch.jit.trace(net.eval(), _x)
    mobilenet_v3_smallmodel.save(path_dir / "mobilenet_v3_small.pt")
    print(net)
