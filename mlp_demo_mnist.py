...
class Network(nn.Module):
    def __init__(self, in_features, num_classes, units=None):
        ...
        if units is None:
            units = [1024, 2048, 512]
        for unit in units:
            layers.append(nn.Linear(in_features, unit))
...
def tt_model():
    best = torch.load(r"./output/02/251028211823/model/best.pkl", map_location="cpu", weights_only=False)
    last = torch.load(r"./output/02/251028211823/model/last.pkl", map_location="cpu", weights_only=False)
...
if __name__ == '__main__':
    # training()
    # tt_model()
    # export(r"./output/02/251028211823/model")
    tt_load_model(r"./output/02/251028211823/model")
